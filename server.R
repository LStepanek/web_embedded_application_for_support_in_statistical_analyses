...
my_server <- function(
    ...
    output$limited_sample_intro <- renderUI({
      intro_box(
        title = "Important: results are based on a limited sample",
        lead = HTML("<i><strong>Note:</strong> The analysis and insights provided below are based on a <strong>limited sample</strong> of the dataset, not the full data. 
      ...
      This summary is intended to offer a <strong>preliminary view</strong> of the data, highlight potential trends, and suggest possible directions for further exploration or more detailed statistical investigation.</i>"),
        note = HTML("<i>Users should interpret the findings with caution and consider them as <strong>guiding insights</strong> rather than absolute conclusions. 
      ...
      so any decisions based solely on this preview should be corroborated with the complete data.</i>")
      )
    })
