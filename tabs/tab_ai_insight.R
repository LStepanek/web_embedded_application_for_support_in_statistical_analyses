...
tab_ai_insight <- tabPanel(
  ...
  tags$div(class = "intro-box",
    tags$p(class = "intro-lead",
      HTML("<i><strong>Note:</strong> The analysis and insights provided below are based on a <strong>limited sample</strong> of the dataset, not the full data.
    ...
    tags$p(class = "intro-note",
      HTML("<i>Users should interpret the findings with caution and consider them as <strong>guiding insights</strong> rather than absolute conclusions.
