...
tab_ai_insight <- tabPanel(
    ...
    div(
      ...
      div(style="font-weight:600; margin-bottom:6px;", "Important: results are based on a limited sample"),
      HTML("<p><i><strong>Note:</strong> The analysis and insights provided below are based on a <strong>limited sample</strong> of the dataset, not the full data. 
      ...
      HTML("<p style='margin:8px 0 0; font-size:90%; color:#0b5394;'><i>Users should interpret the findings with caution and consider them as <strong>guiding insights</strong> rather than absolute conclusions. 
